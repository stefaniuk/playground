...
set SERVICE_DISPLAYNAME=Sample Service
set SERVICE_DESCRIPTION=Sample Service
set PROCRUN=%SERVICE_HOME%\bin\%SERVICE_NAME%.exe
set CLASS=io.codeworks.daemon.SampleService
set JAR=%SERVICE_HOME%\lib\codeworks-daemon-0.0.1-SNAPSHOT.jar
