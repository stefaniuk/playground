...
-- -----------------------------------------------------
-- Table `shellos`.`cpu_usage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `shellos`.`cpu_usage` ;

CREATE  TABLE IF NOT EXISTS `shellos`.`cpu_usage` (
...
-- -----------------------------------------------------
-- Table `shellos`.`memory_usage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `shellos`.`memory_usage` ;

CREATE  TABLE IF NOT EXISTS `shellos`.`memory_usage` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `timestamp` DATETIME NOT NULL ,
  `servername` VARCHAR(32) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `shellos`.`network_usage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `shellos`.`network_usage` ;

CREATE  TABLE IF NOT EXISTS `shellos`.`network_usage` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `timestamp` DATETIME NOT NULL ,
  `servername` VARCHAR(32) NOT NULL ,
  PRIMARY KEY (`id`) ,
...
-- -----------------------------------------------------
-- Table `shellos`.`disk_usage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `shellos`.`disk_usage` ;

CREATE  TABLE IF NOT EXISTS `shellos`.`disk_usage` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `timestamp` DATETIME NOT NULL ,
  `servername` VARCHAR(32) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `shellos`.`memory_usage_processes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `shellos`.`memory_usage_processes` ;

CREATE  TABLE IF NOT EXISTS `shellos`.`memory_usage_processes` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `timestamp` DATETIME NOT NULL ,
  `servername` VARCHAR(32) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `shellos`.`network_connections`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `shellos`.`network_connections` ;

CREATE  TABLE IF NOT EXISTS `shellos`.`network_connections` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `timestamp` DATETIME NOT NULL ,
  `servername` VARCHAR(32) NOT NULL ,
  `local_address` VARCHAR(128) NOT NULL ,
  `local_port` VARCHAR(8) NOT NULL ,
  `foreign_address` VARCHAR(128) NOT NULL ,
