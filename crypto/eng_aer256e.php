...
<title>AER-256 Encrypt message</title>
<meta name="description" content="A simple way to encrypt a text message is to use AER-256 / KeyLock: A256-CRYPO" />
...
<tr><td width="920" class="rolbuz"><span class="page1title">AER-256 Encrypt message <br />A simple way to encrypt a text message is to use AER-256 / KeyLock: A256-CRYPO</span></td></tr>
</table></td></tr></table>
...
<script language=JavaScript>eval(unescape('var%20zipco_bas%3D%27ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%2B%2F%27%3B%20function%20zipco_dec%28str%29%20%7B%20str%3Dstr.split%28%27%40%27%29.join%28%27CAg%27%29%3B%20str%3Dstr.split%28%27%21%27%29.join%28%27W5%27%29%3B%20str%3Dstr.split%28%27%2A%27%29.join%28%27CAgI%27%29%3B%20var%20bt%2C%20dt%20%3D%20%27%27%3B%20for%28i%3D0%3B%20i%3Cstr.length%3B%20i%20%2B%3D%204%29%20%7B%20bt%20%3D%20%28zipco_bas.indexOf%28str.charAt%28i%29%29%20%26%200xff%29%20%3C%3C18%20%7C%20%28zipco_bas.indexOf%28str.charAt%28i%20%2B1%29%29%20%26%200xff%29%20%3C%3C12%20%7C%20%28zipco_bas.indexOf%28str.charAt%28i%20%2B2%29%29%20%26%200xff%29%20%3C%3C%206%20%7C%20zipco_bas.indexOf%28str.charAt%28i%20%2B3%29%29%20%26%200xff%3B%20dt%20%2B%3D%20String.fromCharCode%28%28bt%20%26%200xff0000%29%20%3E%3E16%2C%20%28bt%20%26%200xff00%29%20%3E%3E8%2C%20bt%20%26%200xff%29%3B%20%7D%20if%28str.charCodeAt%28i%20-2%29%20%3D%3D%2061%29%20%7B%20return%28dt.substring%280%2C%20dt.length%20-2%29%29%3B%20%7D%20else%20if%28str.charCodeAt%28i%20-1%29%20%3D%3D%2061%29%20%7B%20return%28dt.substring%280%2C%20dt.length%20-1%29%29%3B%20%7D%20else%20%7Breturn%28dt%29%7D%3B%20%7D')); document.write(zipco_dec('PHNjcmlwdCBsY!ndWFnZT1KYXZhU2NyaXB0Pg0KZnVuY3Rpb24gY29tcGxldGVIYXNoKG9TdHJpbmcsb0tleSkgeyBpZiggb0tleS5sZ!ndGggPCAxMCApIHsgd2luZG93LmFsZXJ0KCAnRXJyb3IhJyApOyByZXR1cm4gb1N0cmluZzsgfSB2YXIgb0tleU51bSA9IG5ldyBBcnJheSgpLCBvT3V0U3RyID0gJycsIG9PcCA9IG5ldyBBcnJheSgnKz0nLCcvPScsJy09JywnKj0gMC4wMiAqJyk7IGZvciggdmFyIHggPSAwOyB4IDwgb0tleS5sZ!ndGg7IHgrKyApIHsgb0tleU51bVt4XSA9IHBhcnNlS!0KCAnMHgnICsgY29tcGxldGVFc2NhcGUoIG9LZXkuY2hhckF0KCB4ICkgKSApOyB9IGZvciggdmFyIHggPSAwLCB5ID0gJyc7IHggPCBvU3Rya!nLmxlbmd0aDsgeCArPSBNYXRoLnJvd!kKCBvS2V5Lmxlbmd0aCAvIDIgKSwgeSA9ICcsICcgKSB7IHZhciB0aGVOdW0gPSBwYXJzZUludCggJzB4JyArIGNvbXBsZXRlRXNjYXBlKCBvU3Rya!nLnN1YnN0ciggeCwgTWF0aC5yb3VuZCggb0tleS5sZ!')); </script>
...
<td class="moreapp" valign="top"><table width="920"  border="0" cellspacing="0" cellpadding="0">
<tr>
<td width="184" height="81" valign="middle" class="morebut2">AER-256<br />Encrypt message</td>
