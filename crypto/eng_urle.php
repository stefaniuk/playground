...
<title>URL-Encode v1 (Encode URL to Unicode String)</title>
...
<tr><td width="920" class="rolbuz"><span class="page1title">URL-Encode v1 (Encode URL to Unicode String) <br />Universal tool that converts URL into a Unicode string</span></td></tr>
</table></td></tr></table>
...
<tr><td valign="top"><textarea class="m2write" onKeyUp="this.form.dest.value = encodeURIComponent(this.form.src.value)" name="src"></textarea></td></tr>
...
<tr>
<tr>
<td width="184" height="81" valign="middle" class="moredut2">URL-Encode v1<br />Encode to Unicode String</td>
...
<div style="float:left;">[ ONLINE: 17 USERS ]<br>Copyright &copy; 2007-2011 Crypo<br>All rights reserved</div>
