...
<title>Simple-Passsword Generator v4</title>
...
<tr><td class="ctitle" valign="middle">Random numeric characters (0-9) Length: 12 symbols</td></tr>
<tr><td valign="top"><input type=text class="passogen"  name="passbox"  readonly="readonly"/><input name="length" value="12" type="hidden"/></td></tr>
...
<td width="184" height="81" valign="middle" class="moredut2">Unique-Password<br />Generator v4</td>
...
<div style="float:left;">[ ONLINE: 30 USERS ]<br>Copyright &copy; 2007-2011 Crypo<br>All rights reserved</div>
