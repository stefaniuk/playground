...
<title>TRIPO-5 Encrypt or Decrypt message</title>
<meta name="description" content="A simple way to encrypt / decrypt a text message is to use TRIPO-5" />
...
<td width="55%">Type or paste in the text you want to encrypt or paste TRIPO-5 encrypted message into the text field and click decrypt!</td>
</tr></table></td></tr>
...
<td width="184" height="81" valign="middle" class="moredut2">TRIPO-5 + <br />Encrypt / Decrypt</td>
...
<div style="float:left;">[ ONLINE: 53 USERS ]<br>Copyright &copy; 2007-2011 Crypo<br>All rights reserved</div>
