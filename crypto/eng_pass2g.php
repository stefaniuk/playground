...
<title>Simple-Passsword Generator v2</title>
<meta name="description" content="This script can be used to generate random passwords for improved password strength." />
...
<tr><td class="ctitle" valign="middle">Random Alpha-Numeric characters (a-z, A-Z, 0-9) Length: 18 symbols</td></tr>
<tr><td valign="top"><input type=text class="passogen"  name="passbox"  readonly="readonly"/><input name="length" value="18" type="hidden"/></td></tr>
</table></td></tr></table></td></tr></tr>
<tr><td class="infobot"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="15%"><input type="button" class="button" value="generate" onclick="javascript:formSubmit()"  /></td>
<td width="15%"><input class="button" type="reset" value="clear" name="clear" /></td>
<td width="70%">This is the function used to generate the random passwords, it takes the required password length as an argument and returns a random password string.</td>
</tr></table></td></tr>
...
<td width="184" height="81" valign="middle" class="moredut2">Unique-Password<br />Generator v2</td>
...
<div style="float:left;">[ ONLINE: 27 USERS ]<br>Copyright &copy; 2007-2011 Crypo<br>All rights reserved</div>
