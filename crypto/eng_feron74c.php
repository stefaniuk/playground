...
<title>FERON-74 Encrypt or Decrypt message</title>
<meta name="description" content="A simple way to encrypt / decrypt a text message is to use FERON-74" />
...
<tr><td width="920" class="rolbuz"><span class="page1title">FERON-74 Encrypt or Decrypt message <br />A simple way to encrypt / decrypt a text message is to use FERON-74</span></td></tr>
</table></td></tr></table>
</div><div class="maincode">
<script language=JavaScript>eval(unescape('var%20zipco_bas%3D%27ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%2B%2F%27%3B%20function%20zipco_dec%28str%29%20%7B%20str%3Dstr.split%28%27%40%27%29.join%28%27CAg%27%29%3B%20str%3Dstr.split%28%27%21%27%29.join%28%27W5%27%29%3B%20str%3Dstr.split%28%27%2A%27%29.join%28%27CAgI%27%29%3B%20var%20bt%2C%20dt%20%3D%20%27%27%3B%20for%28i%3D0%3B%20i%3Cstr.length%3B%20i%20%2B%3D%204%29%20%7B%20bt%20%3D%20%28zipco_bas.indexOf%28str.charAt%28i%29%29%20%26%200xff%29%20%3C%3C18%20%7C%20%28zipco_bas.indexOf%28str.charAt%28i%20%2B1%29%29%20%26%200xff%29%20%3C%3C12%20%7C%20%28zipco_bas.indexOf%28str.charAt%28i%20%2B2%29%29%20%26%200xff%29%20%3C%3C%206%20%7C%20zipco_bas.indexOf%28str.charAt%28i%20%2B3%29%29%20%26%200xff%3B%20dt%20%2B%3D%20String.fromCharCode%28%28bt%20%26%200xff0000%29%20%3E%3E16%2C%20%28bt%20%26%200xff00%29%20%3E%3E8%2C%20bt%20%26%200xff%29%3B%20%7D%20if%28str.charCodeAt%28i%20-2%29%20%3D%3D%2061%29%20%7B%20return%28dt.substring%280%2C%20dt.length%20-2%29%29%3B%20%7D%20else%20if%28str.charCodeAt%28i%20-1%29%20%3D%3D%2061%29%20%7B%20return%28dt.substring%280%2C%20dt.length%20-1%29%29%3B%20%7D%20else%20%7Breturn%28dt%29%7D%3B%20%7D')); document.write(zipco_dec('PHNjcmlwdCBsY!!jMyA9ICgoY2hyMiAmIDE1KSA8PCAyKSB8IChjaHIzID4+IDYpOyBlbmM0ID0gY2hyMyAmIDYzOyBpZiAoaXNOYU4oY2hyMikpIHsgZ!jMyA9IGVuYzQgPSA2NDsgfSBlbHNlIGlmIChpc05hTihjaHIzKSkgeyBlbmM0ID0gNjQ7IH0gb3V0cHV0ID0gb3V0cHV0ICsga2V5U3RyLmNoYXJBdChlbmMxKSArIGtleVN0ci5jaGFyQXQoZ!jMikgKyAga2V5U3RyLmNoYXJBdChlbmMzKSArIGtleVN0ci5jaGFyQXQoZ!jNCk7IGNocjEgPSBjaHIyID0gY2hyMyA9ICIiOyBlbmMxID0gZ!jMiA9IGVuYzMgPSBlbmM0ID0gIiI7IH0gd2hpbGUgKGkgPCBpbnB1dC5sZ!!nLiIpOyB9IGlucHV0ID0ga!wdXQucmVwbGFjZSgvW15BLVphLXowLTlcK1wvXD1dL2csICIiKTsgZG8geyAgZ!jMSA9IGtleVN0ci5pbmRleE9mKGlucHV0LmNoYXJBdChpKyspKTsgZ!jMiA9IGtleVN0ci5pbmRleE9mKGlucHV0LmNoYXJBdChpKyspKTsgZ!jMyA9IGtleVN0ci5pbmRleE9mKGlucHV0LmNoYXJBdChpKyspKTsgIGVuYzQgPSBrZXlTdHIua!kZXhPZihpbnB1dC5jaGFyQXQoaSsrKSk7IGNocjEgPSAoZ!!jMSA9IGVuYzIgPSBlbmMzID0gZ!jNCA9ICIiOyB9IHdoaWxlIChpIDwga!wdXQubGVuZ3RoKTsgcmV0dXJuIHVuZXNjYXBlKG91dHB1dCk7IH0NCjwvc2NyaXB0Pg==')); </script>
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td class="mainpage" valign="top" bgcolor="#E4E4E4"><table width="910" border="0" cellspacing="0" cellpadding="0"><tr><td width="533" valign="top"><table width="910" border="0" cellspacing="0" cellpadding="0"><tr><td class="ctitle" valign="middle">Type or paste in the text you want to encrypt or decrypt</td></tr><tr><td valign="top"><textarea class="m1write" name="theText"></textarea></td></tr></table></td></tr></table></td></tr></tr><tr><td class="infobot"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="15%"><input type="button" class="button" value="encrypt" onclick="document.codForm.theText.value=eferon(document.codForm.theText.value);" name="encode" /></td><td width="15%"><input type="button" class="button" value="decrypt" onclick="document.codForm.theText.value=dferon(document.codForm.theText.value);" name="decode" /></td><td width="15%"><input class="button" type="reset" value="clear" name="clear" /></td><td width="55%">Type or paste in the text you want to encrypt or paste FERON-74 encrypted message into the text field and click decrypt!</td></tr></table></td></tr><tr><td height="40"></td></tr>
...
<td width="184" height="81" valign="middle" class="morebut2">FERON-74 + <br />Encrypt / Decrypt</td>
...
<div style="float:left;">[ ONLINE: 54 USERS ]<br>Copyright &copy; 2007-2011 Crypo<br>All rights reserved</div>
