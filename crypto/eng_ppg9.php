...
<title>PassPhrase Generator v9</title>
...
<tr><td valign="top"><textarea class="m3write" onKeyUp="this.form.hash.value = port(this.form.decoded.value)" name="decoded"></textarea></td></tr>
...
<td width="184" height="81" valign="middle" class="moredut2">PassPhrase<br />Generator v9</td>
...
<div style="float:left;">[ ONLINE: 38 USERS ]<br>Copyright &copy; 2007-2011 Crypo<br>All rights reserved</div>
