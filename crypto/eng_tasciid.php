...
<title>T-ASCII Decode</title>
<meta name="description" content="Transforms Text from T-ASCII" />
...
<tr><td class="ctitle" valign="middle">Type or paste in the text you want to T-ASCII decode</td></tr>
<tr><td valign="top"><textarea class="m2write"  name="c2"></textarea></td></tr>
...
<tr><td valign="top"><textarea class="m4write"  name="f2" readonly="readonly"></textarea></td></tr> 
</table></td></tr></table></td></tr></tr><tr>
<td class="infobot"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
<td width="15%"><input type="button" class="button" value="decode" onclick="document.fB.f2.value=unescapeTxt(document.fB.c2.value)" /></td>
<td width="15%"><input class="button" type="reset" value="clear" name="clear" /></td>
<td width="70%">T-ASCII Decode is a tool that converts text into a Unicode-ASCII string which means the text looks scrambled when your source code is viewed, but when executed as a web page, appears to be normal. </td>
</tr></table></td></tr>
...
<td width="184" height="81" valign="middle" class="moredut2">T-ASCII<br />Decoder</td>
