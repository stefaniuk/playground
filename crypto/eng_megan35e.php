...
<title>MEGAN-35 Encrypt message</title>
<meta name="description" content="A simple way to encrypt a text message is to use MEGAN-35" />
...
<td width="15%"><input type="button" class="button" value="encrypt" onclick="document.codForm.theText.value=encrypto(document.codForm.theText.value);" name="encode" /></td>
...
<td width="184" height="81" valign="middle" class="morebuz2">MEGAN-35<br />Encrypt message</td>
</tr>
<tr>
