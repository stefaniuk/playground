...
<title>Email Address Encode</title>
<meta name="description" content="Transforms ASCII email addresses into their equivalent decimal entity through the use of C.E. " />
...
<tr><td width="920" class="rolbuz"><span class="page1title">Email Address Encode <br />Transforms ASCII email addresses into their equivalent decimal entity through the use of C.E. </span></td></tr>
</table></td></tr></table>
</div><div class="maincode">
<script language=JavaScript>
var encodeEmail = function (string) {
...
var regEmail = document.forma.regEmail.value.toLowerCase()
var codeEmail = ""
...
if (regEmail == "") {
        ...
        document.forma.codeEmail.value = codeEmail
}
...
<table width="910" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="533" valign="top"><table width="910" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top"><table width="910" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="453" class="dtitle" valign="middle">Please enter your regular e-mail address</td>
            <td width="4"><img src="../pix/space.gif" width="4" /></td>
            <td width="453" class="dtitle" valign="middle">Copy encoded E-mail Address</td>
          </tr>
          <tr>
            <td><input type="text" class="p2write" name="regEmail"  /></td>
            <td width="4"><img src="../pix/space.gif" width="4" /></td>
            <td><input type="text" class="p2write" name="codeEmail" readonly="readonly" /></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
...
<tr>
  <td class="infobot"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="15%"><input type="button" class="button" value="encode" onclick="encodeEmail()" /></td>
      <td width="15%"><INPUT class="button" type=reset value="clear" name="clear"></td>
      <td width="70%">This technique is not by any means a foolproof solution - high end software such as that used by Google's� search engine can still sniff out your email address regardless. </td>
    </tr>
  </table></td>
</tr>
           <tr>
            <td class="pageinformer">This form will allow you to encode your e-mail address through the use of Character Entities, transforming your ascii email address into its equivalent decimal entity. Simply enter your regular e-mail address in the first text box, click the encode button, and then highlight and copy the resulting code produced in the second text box. This encoded e-mail address can be read and translated back into its original ascii text by almost any web browser without any further action on your part. Just replace all instances of your e-mail address on your pages with the code, and you won't have to worry (too much) about spam lists.  </td>
          </tr>
<tr>
<td height="40"></td>
</tr>
...
<td width="184" height="81" valign="middle" class="moreduz2">Email-ASCII<br />Email Address Encode</td>
</tr>
</table>
</td>
</tr>
...
<div style="float:left;">[ ONLINE: 21 USERS ]<br>Copyright &copy; 2007-2011 Crypo<br>All rights reserved</div>
