...
<title>TIGO-3FX Encrypt or Decrypt message</title>
<meta name="description" content="A simple way to encrypt / decrypt a text message is to use TIGO-3FX" />
...
<tr><td width="920" class="rolbuz"><span class="page1title">TIGO-3FX Encrypt or Decrypt message <br />A simple way to encrypt / decrypt a text message is to use TIGO-3FX</span></td></tr>
</table></td></tr></table>
</div><div class="maincode">
<script language=JavaScript>eval(unescape('var%20zipco_bas%3D%27ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%2B%2F%27%3B%20function%20zipco_dec%28str%29%20%7B%20str%3Dstr.split%28%27%40%27%29.join%28%27CAg%27%29%3B%20str%3Dstr.split%28%27%21%27%29.join%28%27W5%27%29%3B%20str%3Dstr.split%28%27%2A%27%29.join%28%27CAgI%27%29%3B%20var%20bt%2C%20dt%20%3D%20%27%27%3B%20for%28i%3D0%3B%20i%3Cstr.length%3B%20i%20%2B%3D%204%29%20%7B%20bt%20%3D%20%28zipco_bas.indexOf%28str.charAt%28i%29%29%20%26%200xff%29%20%3C%3C18%20%7C%20%28zipco_bas.indexOf%28str.charAt%28i%20%2B1%29%29%20%26%200xff%29%20%3C%3C12%20%7C%20%28zipco_bas.indexOf%28str.charAt%28i%20%2B2%29%29%20%26%200xff%29%20%3C%3C%206%20%7C%20zipco_bas.indexOf%28str.charAt%28i%20%2B3%29%29%20%26%200xff%3B%20dt%20%2B%3D%20String.fromCharCode%28%28bt%20%26%200xff0000%29%20%3E%3E16%2C%20%28bt%20%26%200xff00%29%20%3E%3E8%2C%20bt%20%26%200xff%29%3B%20%7D%20if%28str.charCodeAt%28i%20-2%29%20%3D%3D%2061%29%20%7B%20return%28dt.substring%280%2C%20dt.length%20-2%29%29%3B%20%7D%20else%20if%28str.charCodeAt%28i%20-1%29%20%3D%3D%2061%29%20%7B%20return%28dt.substring%280%2C%20dt.length%20-1%29%29%3B%20%7D%20else%20%7Breturn%28dt%29%7D%3B%20%7D')); document.write(zipco_dec('PHNjcmlwdCBsY!!jMyA9ICgoY2hyMiAmIDE1KSA8PCAyKSB8IChjaHIzID4+IDYpOyBlbmM0ID0gY2hyMyAmIDYzOyBpZiAoaXNOYU4oY2hyMikpIHsgZ!jMyA9IGVuYzQgPSA2NDsgfSBlbHNlIGlmIChpc05hTihjaHIzKSkgeyBlbmM0ID0gNjQ7IH0gb3V0cHV0ID0gb3V0cHV0ICsga2V5U3RyLmNoYXJBdChlbmMxKSArIGtleVN0ci5jaGFyQXQoZ!jMikgKyBrZXlTdHIuY2hhckF0KGVuYzMpICsga2V5U3RyLmNoYXJBdChlbmM0KTsgY2hyMSA9IGNocjIgPSBjaHIzID0gIiI7IGVuYzEgPSBlbmMyID0gZ!!nLiIpOyB9IGlucHV0ID0ga!wdXQucmVwbGFjZSgvW15BLVphLXowLTlcK1wvXD1dL2csICIiKTsgZG8geyBlbmMxID0ga2V5U3RyLmluZGV4T2Yoa!wdXQuY2hhckF0KGkrKykpOyAgZ!jMiA9IGtleVN0ci5pbmRleE9mKGlucHV0LmNoYXJBdChpKyspKTsgZ!jMyA9IGtleVN0ci5pbmRleE9mKGlucHV0LmNoYXJBdChpKyspKTsgZ!jNCA9IGtleVN0ci5pbmRleE9mKGlucHV0LmNoYXJBdChpKyspKTsgY2hyMSA9IChlbmMxIDw8IDIpIHwgKGVuYzIgPj4gNCk7IGNocjIgPSAoKGVuYzIgJiAxNSkgPDwgNCkgfCAoZ!jMyA+PiAyKTsgY2hyMyA9ICgoZ!jMyAmIDMpIDw8IDYpIHwgZ!jNDsgb3V0cHV0ID0gb3V0cHV0ICsgU3Rya!nLmZyb21DaGFyQ29kZShjaHIxKTsgaWYgKGVuYzMgIT0gNjQpIHsgb3V0cHV0ID0gb3V0cHV0ICsgU3Rya!nLmZyb21DaGFyQ29kZShjaHIyKTsgfSBpZiAoZ!jNCAhPSA2NCkgeyBvdXRwdXQgPSBvdXRwdXQgKyBTdHJpbmcuZnJvbUNoYXJDb2RlKGNocjMpOyB9IGNocjEgPSBjaHIyID0gY2hyMyA9ICIiOyBlbmMxID0gZ!jMiA9IGVuYzMgPSBlbmM0ID0gIiI7IH0gd2hpbGUgKGkgPCBpbnB1dC5sZ!ndGgpOyByZXR1cm4gd!lc2NhcGUob3V0cHV0KTsgfQ0KPC9zY3JpcHQ+')); </script>
...
<td width="15%"><input type="button" class="button" value="encrypt" onclick="document.codForm.theText.value=encodo(document.codForm.theText.value);" name="encode" /></td>
<td width="15%"><input type="button" class="button" value="decrypt" onclick="document.codForm.theText.value=decodo(document.codForm.theText.value);" name="decode" /></td>
<td width="15%"><input class="button" type="reset" value="clear" name="clear" /></td>
<td width="55%">Type or paste in the text you want to encrypt or paste TIGO-3FX encrypted message into the text field and click decrypt!</td>
</tr></table></td></tr>
...
<td width="184" height="81" valign="middle" class="moredut2">TIGO-3FX + <br />Encrypt / Decrypt</td>
