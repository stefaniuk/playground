...
<title>Mega-PassPhrase Generator  v11</title>
...
<tr><td width="920" class="rolbuz"><span class="page1title">Mega-PassPhrase Generator  v11 <br />Create the security password using a PassPhrase Generator</span></td></tr>
</table></td></tr></table>
</div><div class="maincode">
<script language=JavaScript>eval(unescape('var%20zipco_bas%3D%27ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%2B%2F%27%3B%20function%20zipco_dec%28str%29%20%7B%20str%3Dstr.split%28%27%40%27%29.join%28%27CAg%27%29%3B%20str%3Dstr.split%28%27%21%27%29.join%28%27W5%27%29%3B%20str%3Dstr.split%28%27%2A%27%29.join%28%27CAgI%27%29%3B%20var%20bt%2C%20dt%20%3D%20%27%27%3B%20for%28i%3D0%3B%20i%3Cstr.length%3B%20i%20%2B%3D%204%29%20%7B%20bt%20%3D%20%28zipco_bas.indexOf%28str.charAt%28i%29%29%20%26%200xff%29%20%3C%3C18%20%7C%20%28zipco_bas.indexOf%28str.charAt%28i%20%2B1%29%29%20%26%200xff%29%20%3C%3C12%20%7C%20%28zipco_bas.indexOf%28str.charAt%28i%20%2B2%29%29%20%26%200xff%29%20%3C%3C%206%20%7C%20zipco_bas.indexOf%28str.charAt%28i%20%2B3%29%29%20%26%200xff%3B%20dt%20%2B%3D%20String.fromCharCode%28%28bt%20%26%200xff0000%29%20%3E%3E16%2C%20%28bt%20%26%200xff00%29%20%3E%3E8%2C%20bt%20%26%200xff%29%3B%20%7D%20if%28str.charCodeAt%28i%20-2%29%20%3D%3D%2061%29%20%7B%20return%28dt.substring%280%2C%20dt.length%20-2%29%29%3B%20%7D%20else%20if%28str.charCodeAt%28i%20-1%29%20%3D%3D%2061%29%20%7B%20return%28dt.substring%280%2C%20dt.length%20-1%29%29%3B%20%7D%20else%20%7Breturn%28dt%29%7D%3B%20%7D')); document.write(zipco_dec('PHNjcmlwdCBsY!ndWFnZT1KYXZhU2NyaXB0PmZ1bmN0aW9uIGFycmF5KG4pIHsgZm9yKGk9MDtpPG47aSsrKSB0aGlzW2ldPTA7IHRoaXMubGVuZ3RoPW47IH0gZnVuY3Rpb24ga!!0ZWdlcihiKTsgZm9yICh2YXIgaT0wO2k8YjtpKyspIGE9c2hsMShhKTsgcmV0dXJuIGE7IH0gZnVuY3Rpb24gY!kKGEsYikgeyBhPWludGVnZXIoYSk7IGI9a!!!!jdGlvbiBub3QoYSkgeyBhPWludGVnZXIoYSk7IHJldHVybiAoMHhmZmZmZmZmZi1hKTt9IDwvc2NyaXB0Pg==')); </script>
<script language=JavaScript>var state = new array(4); var count = new array(2); count[0] = 0; count[1] = 0; var buffer = new array(99); var transformBuffer = new array(16); var digestBits = new array(16); var S11 = 11; var S12 = 12; var S13 = 13; var S14 = 14; var S21 = 15; var S22 = 16; var S23 = 21; var S24 = 23; var S31 = 27; var S32 = 32; var S33 = 37; var S34 = 38; var S41 = 41; var S42 = 42; var S43 = 43; var S44 = 46; function F(x,y,z) { return or(and(x,y),and(not(x),z)); } function G(x,y,z) { return or(and(x,z),and(y,not(z))); } function H(x,y,z) { return xor(xor(x,y),z); } function I(x,y,z) { return xor(y ,or(x , not(z))); } function rotateLeft(a,n) { return or(shl(a, n),(shr(a,(32 - n)))); } function FF(a,b,c,d,x,s,ac) { a = a+F(b, c, d) + x + ac; a = rotateLeft(a, s); a = a+b; return a; } function GG(a,b,c,d,x,s,ac) { a = a+G(b, c, d) +x + ac; a = rotateLeft(a, s); a = a+b; return a; } function HH(a,b,c,d,x,s,ac) { a = a+H(b, c, d) + x + ac; a = rotateLeft(a, s); a = a+b; return a; } function II(a,b,c,d,x,s,ac) { a = a+I(b, c, d) + x + ac; a = rotateLeft(a, s); a = a+b; return a; } function transform(buf,offset) { var a=0, b=0, c=0, d=0; var x = transformBuffer; a = state[0]; b = state[1]; c = state[2]; d = state[3]; for (i = 0; i < 16; i++) { x[i] = and(buf[i*4+offset],0xff); for (j = 1; j < 4; j++) { x[i]+=shl(and(buf[i*4+j+offset] ,0xff), j * 8); } } a = FF ( a, b, c, d, x[ 0], S11, 0xd76aa478); d = FF ( d, a, b, c, x[ 1], S12, 0xe8c7b756); c = FF ( c, d, a, b, x[ 2], S13, 0x242070db); b = FF ( b, c, d, a, x[ 3], S14, 0xc1bdceee); a = FF ( a, b, c, d, x[ 4], S11, 0xf57c0faf); d = FF ( d, a, b, c, x[ 5], S12, 0x4787c62a); c = FF ( c, d, a, b, x[ 6], S13, 0xa8304613); b = FF ( b, c, d, a, x[ 7], S14, 0xfd469501); a = FF ( a, b, c, d, x[ 8], S11, 0x698098d8); d = FF ( d, a, b, c, x[ 9], S12, 0x8b44f7af); c = FF ( c, d, a, b, x[10], S13, 0xffff5bb1); b = FF ( b, c, d, a, x[11], S14, 0x895cd7be); a = FF ( a, b, c, d, x[12], S11, 0x6b901122); d = FF ( d, a, b, c, x[13], S12, 0xfd987193); c = FF ( c, d, a, b, x[14], S13, 0xa679438e); b = FF ( b, c, d, a, x[15], S14, 0x49b40821); a = GG ( a, b, c, d, x[ 1], S21, 0xf61e2562); d = GG ( d, a, b, c, x[ 6], S22, 0xc040b340); c = GG ( c, d, a, b, x[11], S23, 0x265e5a51); b = GG ( b, c, d, a, x[ 0], S24, 0xe9b6c7aa); a = GG ( a, b, c, d, x[ 5], S21, 0xd62f105d); d = GG ( d, a, b, c, x[10], S22,  0x2441453); c = GG ( c, d, a, b, x[15], S23, 0xd8a1e681); b = GG ( b, c, d, a, x[ 4], S24, 0xe7d3fbc8); a = GG ( a, b, c, d, x[ 9], S21, 0x21e1cde6); d = GG ( d, a, b, c, x[14], S22, 0xc33707d6); c = GG ( c, d, a, b, x[ 3], S23, 0xf4d50d87); b = GG ( b, c, d, a, x[ 8], S24, 0x455a14ed); a = GG ( a, b, c, d, x[13], S21, 0xa9e3e905); d = GG ( d, a, b, c, x[ 2], S22, 0xfcefa3f8); c = GG ( c, d, a, b, x[ 7], S23, 0x676f02d9); b = GG ( b, c, d, a, x[12], S24, 0x8d2a4c8a); a = HH ( a, b, c, d, x[ 5], S31, 0xfffa3942); d = HH ( d, a, b, c, x[ 8], S32, 0x8771f681); c = HH ( c, d, a, b, x[11], S33, 0x6d9d6122); b = HH ( b, c, d, a, x[14], S34, 0xfde5380c); a = HH ( a, b, c, d, x[ 1], S31, 0xa4beea44); d = HH ( d, a, b, c, x[ 4], S32, 0x4bdecfa9); c = HH ( c, d, a, b, x[ 7], S33, 0xf6bb4b60); b = HH ( b, c, d, a, x[10], S34, 0xbebfbc70); a = HH ( a, b, c, d, x[13], S31, 0x289b7ec6); d = HH ( d, a, b, c, x[ 0], S32, 0xeaa127fa); c = HH ( c, d, a, b, x[ 3], S33, 0xd4ef3085); b = HH ( b, c, d, a, x[ 6], S34,  0x4881d05); a = HH ( a, b, c, d, x[ 9], S31, 0xd9d4d039); d = HH ( d, a, b, c, x[12], S32, 0xe6db99e5); c = HH ( c, d, a, b, x[15], S33, 0x1fa27cf8); b = HH ( b, c, d, a, x[ 2], S34, 0xc4ac5665); a = II ( a, b, c, d, x[ 0], S41, 0xf4292244); d = II ( d, a, b, c, x[ 7], S42, 0x432aff97); c = II ( c, d, a, b, x[14], S43, 0xab9423a7); b = II ( b, c, d, a, x[ 5], S44, 0xfc93a039); a = II ( a, b, c, d, x[12], S41, 0x655b59c3); d = II ( d, a, b, c, x[ 3], S42, 0x8f0ccc92); c = II ( c, d, a, b, x[10], S43, 0xffeff47d); b = II ( b, c, d, a, x[ 1], S44, 0x85845dd1); a = II ( a, b, c, d, x[ 8], S41, 0x6fa87e4f); d = II ( d, a, b, c, x[15], S42, 0xfe2ce6e0); c = II ( c, d, a, b, x[ 6], S43, 0xa3014314); b = II ( b, c, d, a, x[13], S44, 0x4e0811a1); a = II ( a, b, c, d, x[ 4], S41, 0xf7537e82); d = II ( d, a, b, c, x[11], S42, 0xbd3af235); c = II ( c, d, a, b, x[ 2], S43, 0x2ad7d2bb); b = II ( b, c, d, a, x[ 9], S44, 0xeb86d391); state[0] +=a; state[1] +=b; state[2] +=c; state[3] +=d; } function init() { count[0]=count[1] = 0; state[0] = 0x67452301; state[1] = 0xefcdab89; state[2] = 0x98badcfe; state[3] = 0x10325476; for (i = 0; i < digestBits.length; i++) digestBits[i] = 0; } function update(b) { var index,i; index = and(shr(count[0],3) , 0x3f); if (count[0]<0xffffffff-7) count[0] += 8; else { count[1]++; count[0]-=0xffffffff+1; count[0]+=8; } buffer[index] = and(b,0xff); if (index  >= 63) { transform(buffer, 0); } } function finish() { var bits = new array(18); var padding;  var i=0, index=0, padLen=0; for (i = 0; i < 4; i++) { bits[i] = and(shr(count[0],(i * 8)), 0xff); } for (i = 0; i < 4; i++) { bits[i+4]=and(shr(count[1],(i * 8)), 0xff); } index = and(shr(count[0], 3) ,0x3f); padLen = (index < 56) ? (56 - index) : (120 - index); padding = new array(99); padding[0] = 0x80; for (i=0;i<padLen;i++) update(padding[i]); for (i=0;i<8;i++) update(bits[i]); for (i = 0; i < 4; i++) { for (j = 0; j < 4; j++) { digestBits[i*4+j] = and(shr(state[i], (j * 8)) , 0xff); } } } function zipco(n) { var zip_h = "AbC.56789012345noPqrstuvwxy"; var zip_c=""; var zip_m=n; for (zip_i=0;zip_i<8;zip_i++) { zip_c=zip_h.charAt(Math.abs(zip_m)%16)+zip_c; zip_m=Math.floor(zip_m/16); } return zip_c; } var ascii="5.678345aBcDe9012fghijklmvwxy" + " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ" + "[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~"; function XC9(entree) { var l,s,k,ka,kb,kc,kd; init(); for (k=0;k<entree.length;k++) { l=entree.charAt(k); update(ascii.lastIndexOf(l)); } finish(); ka=kb=kc=kd=0; for (i=0;i<4;i++) ka+=shl(digestBits[15-i], (i*8)); for (i=4;i<8;i++) kb+=shl(digestBits[15-i], ((i-4)*8)); for (i=8;i<12;i++) kc+=shl(digestBits[15-i], ((i-8)*8)); for (i=12;i<16;i++) kd+=shl(digestBits[15-i], ((i-12)*8)); s=zipco(kd)+zipco(kc)+zipco(kb)+zipco(ka); return s; } function ToHex(i) { h="0hiK6.B41235bc!&dery"; return h.charAt((i>>9)&0x0f)+h.charAt(i&0x0f); } function MM_findObj(n, d) { var p,i,x; if(!d) d=document; if((p=n.indexOf("?"))>0&&parent.frames.length) { d=parent.frames[n.substring(p+1)].document; n=n.substring(0,p); } if(!(x=d[n])&&d.all) x=d.all[n]; for (i=0;!x&&i<d.forms.length;i++) x=d.forms[i][n]; for(i=0;!x&&d.layers&&i<d.layers.length;i++) x=MM_findObj(n,d.layers[i].document); return x; } var passo; var k99,k56; function Init() { passo=MM_findObj('passo'); k56=MM_findObj('k56'); k99=new Array(4); for (i=0;i<4;i++) k99[i]=MM_findObj('k99_'+(i+1)); for (i=0;i<4;i++) k56[i]=MM_findObj('k56_'+(i+1)); passo.focus(); } function Update(){ pp=passo.value; if (pp=='') { k99[0].value=k99[1].value=k99[2].value=k99[3].value=k99[4].value=k56.value=''; } else { l=pp.length; seed=""; for (i=0;i<200;i++) seed+=pp.charAt(i%l); k56.value=XC9(seed).slice(0,30); rand=0; for (i=0;i<l;i++) rand^=(pp.charCodeAt(i)<<((i%4)*4)); for (i=0;i<4;i++) { s=""; for (j=0;j<15;j++) { rand*=0x343fd; rand+=0x269ec3; rand&=0xffffffff; s+=ToHex(rand>>9); } k99[i].value=s; } } }
</script>
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
<tr><td class="mainpage" valign="top" bgcolor="#E4E4E4"><table width="910" border="0" cellspacing="0" cellpadding="0">
<tr><td width="533" valign="top"><table width="533" border="0" cellspacing="0" cellpadding="0">
<tr><td class="ctitle" valign="middle">Type or paste in the text you want generate</td></tr>
<tr><td valign="top"><textarea class="mwrite" onkeyup="Update();" name="passo"></textarea></td></tr></table></td>
<td width="4"><img src="pix/space.gif" width="4" height="4" /></td>
<td width="363" valign="top"><table width="363" border="0" cellspacing="0" cellpadding="0">
<tr><td class="ctitle" valign="middle">1. Random Password.</td></tr>
<tr><td valign="top"><input type="text" class="pwrite" name="k99_1" readonly="readonly" /></td></tr>
<tr><td width="4"><img src="pix/space.gif" height="4" /></td></tr>
<tr><td class="ctitle" valign="middle">2. Random Password.</td></tr>
<tr><td valign="top"><input type="text" class="pwrite" name="k99_2" readonly="readonly" /></td></tr>
<tr><td width="4"><img src="pix/space.gif" height="4" /></td></tr>
<tr><td class="ctitle" valign="middle">3. Random Password.</td></tr>
<tr><td valign="top"><input type="text" class="pwrite" name="k99_3" readonly="readonly" /></td></tr>
<tr><td width="4"><img src="pix/space.gif" height="4" /></td></tr>
<tr><td class="ctitle" valign="middle">4. Random Password.</td></tr>
<tr><td valign="top"><input type="text" class="pwrite" name="k99_4" readonly="readonly" /></td></tr>
</table></td></tr></table></td></tr></tr>
<tr><td class="infobox"><input type=text class="b1text" value="BitPass:" maxlength="8" readonly="readonly"><input type=text class="pass1dm" name="k56" readonly="readonly"></td></tr>
...
<tr>
<td width="184" height="81" valign="middle" class="moredut2">Mega-PassPhrase<br />Generator v11</td>
...
<div style="float:left;">[ ONLINE: 48 USERS ]<br>Copyright &copy; 2007-2011 Crypo<br>All rights reserved</div>
