define("code4ge/jsf/date", [
	'dojo'
], function(dojo) {

dojo.getObject('date', true, code4ge.jsf);

code4ge.jsf.date.parse = function(/*string*/value, /*object*/options) {
...
// TODO
//
// See http://www.mattkruse.com/javascript/date/source.html
//
...
function parseDate(val) {
	...
	generalFormats = new Array('y-M-d', 'MMM d, y', 'MMM d,y', 'y-MMM-d', 'd-MMM-y', 'MMM d', 'HH:mm:ss', 'THH:mm:ss');
