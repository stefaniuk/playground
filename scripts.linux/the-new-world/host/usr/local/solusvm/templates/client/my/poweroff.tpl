...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="center">
    {if $msg == "01"}
    <div id='infoboxok'><strong>{#poweroff_msg_success#}</strong><br>{#poweroff_msg_01#}</div>
    {elseif $msg == "02"}
    <div id='infoboxerror'><strong>{#poweroff_msg_error#}</strong><br>{#poweroff_msg_02#}</div>
    {elseif $msg == "04"}
    <div id='infoboxerror'><strong>{#poweroff_msg_error#}</strong><br>{#generic_msg_01#}</div>
    {/if}
    </td>
  </tr>
</table>
...
<table class="services" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="25px" style="padding:3px"><h4>{#poweroff_title#}</h4></td>
        </tr>
      <tr>
        <td  style="padding:3px">{#poweroff_title_sub#}</td>
        </tr>
      <tr>
        <td  style="padding:3px"><form id="" method="post" action="">
          <input type="submit" name="poweroff" class="button" id="poweroff" value="{#poweroff_button#}" />
        </form></td>
      </tr>
    </table>
 {include file=$footer}