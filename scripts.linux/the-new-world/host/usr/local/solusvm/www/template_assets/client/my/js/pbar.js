	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/template_assets/client/default/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/template_assets/client/default/images/progressbg_green.gif',
									70: '/template_assets/client/default/images/progressbg_orange.gif',
									90: '/template_assets/client/default/images/progressbg_red.gif'
								},
