...
### 1.
# /usr/local/lxc-tools/lxc-ubuntu create -n vm0
# http://gb.archive.ubuntu.com/ubuntu
# lxc-start --name vm0 --rcfile /usr/local/containers/vm0.conf --logpriority=DEBUG --logfile=/usr/local/vm0.out /bin/bash
# lxc-info --name vm0
