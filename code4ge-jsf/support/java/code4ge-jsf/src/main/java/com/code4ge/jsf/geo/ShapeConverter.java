...
public class ShapeConverter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        (new ShapeConverter()).run();
    }

    public ShapeConverter() throws IOException {
        ...
        scale = AffineTransform.getScaleInstance(size / (re.getMaxX() - re.getMinX()),
            size / (re.getMaxY() - re.getMinY()));
    }
    ...
    public void run() throws IOException {
        ...
        final ArrayList<String> featureNames2 = new ArrayList<String>();
        ...
        FeatureVisitor visitor = new FeatureVisitor() {
            ...
            public void visit(Feature feature) {
                ...
                featureNames2.add(getPctCode((String) name));
        ...
        result.put("featureNames", toJson((List<String>) featureNames2));
        // features
        
        ObjectNode features = mapper.createObjectNode();
        for(String featureName: featureNames) {
            ObjectNode fnNode = mapper.createObjectNode();
            features.put(getPctCode(featureName), fnNode);
    ...
    private Point2D transform2(Point2D point) {
        ...
        return new Point2D.Double(point.getX(), (double) size - point.getY());
    }
    ...
    private String getCipher(String str) {
        ...
        if(str.equals("5JE")) { str = "BAA"; }
        else if(str.equals("5GC")) { str = "BD"; }
        else if(str.equals("5P2")) { str = "BD"; }
        else if(str.equals("5QF")) { str = "BE"; }
        else if(str.equals("5QG")) { str = "BE"; }
        else if(str.equals("5NK")) { str = "BIK"; }
        else if(str.equals("5M1")) { str = "BIR"; }
        else if(str.equals("5MX")) { str = "BIR"; }
        else if(str.equals("5PG")) { str = "BIR"; }
        else if(str.equals("5NY")) { str = "BRA"; }
        else if(str.equals("5A3")) { str = "BRS"; }
        else if(str.equals("5FL")) { str = "BRS"; }
        else if(str.equals("5M8")) { str = "BRS"; }
        else if(str.equals("5QJ")) { str = "BRS"; }
        else if(str.equals("5CQ")) { str = "BU"; }
        else if(str.equals("5QD")) { str = "BU"; }
        else if(str.equals("5PN")) { str = "CB"; }
        else if(str.equals("5PP")) { str = "CB"; }
        else if(str.equals("5J2")) { str = "CH"; }
        else if(str.equals("5NN")) { str = "CH"; }
        else if(str.equals("5NP")) { str = "CH"; }
        else if(str.equals("7A1")) { str = "CLD"; }
        else if(str.equals("7A7")) { str = "CLD"; }
        else if(str.equals("5MD")) { str = "COV"; }
        else if(str.equals("5QP")) { str = "CR"; }
        else if(str.equals("5NE")) { str = "CU"; }
        else if(str.equals("5N5")) { str = "DCR"; }
        else if(str.equals("5N6")) { str = "DE"; }
        else if(str.equals("5N7")) { str = "DE"; }
        else if(str.equals("5F1")) { str = "DN"; }
        else if(str.equals("5QQ")) { str = "DN"; }
        else if(str.equals("TAL")) { str = "DN"; }
        else if(str.equals("5QM")) { str = "DO"; }
        else if(str.equals("5QN")) { str = "DO"; }
        else if(str.equals("5J9")) { str = "DR"; }
        else if(str.equals("5ND")) { str = "DR"; }
        else if(str.equals("5PE")) { str = "DUD"; }
        else if(str.equals("7A2")) { str = "DYF"; }
        else if(str.equals("5P1")) { str = "EX"; }
        else if(str.equals("5PV")) { str = "EX"; }
        else if(str.equals("5PW")) { str = "EX"; }
        else if(str.equals("5PX")) { str = "EX"; }
        else if(str.equals("5PY")) { str = "EX"; }
        else if(str.equals("5KF")) { str = "GAT"; }
        else if(str.equals("5KG")) { str = "GAT"; }
        else if(str.equals("5QH")) { str = "GG"; }
        else if(str.equals("5J5")) { str = "GMK"; }
        else if(str.equals("5LH")) { str = "GMK"; }
        else if(str.equals("7A6")) { str = "GWE"; }
        else if(str.equals("5QV")) { str = "HT"; }
        else if(str.equals("5L3")) { str = "KC"; }
        else if(str.equals("5P9")) { str = "KC"; }
        else if(str.equals("5QA")) { str = "KC"; }
        else if(str.equals("5EF")) { str = "KHU"; }
        else if(str.equals("5NW")) { str = "KHU"; }
        else if(str.equals("5NX")) { str = "KHU"; }
        else if(str.equals("TAN")) { str = "KHU"; }
        else if(str.equals("5HP")) { str = "LA"; }
        else if(str.equals("5NF")) { str = "LA"; }
        else if(str.equals("5NG")) { str = "LA"; }
        else if(str.equals("5NH")) { str = "LA"; }
        else if(str.equals("5NS")) { str = "LA"; }
        else if(str.equals("TAP")) { str = "LA"; }
        else if(str.equals("5PA")) { str = "LD"; }
        else if(str.equals("5PC")) { str = "LD"; }
        else if(str.equals("5N1")) { str = "LDS"; }
        else if(str.equals("5NL")) { str = "LIP"; }
        else if(str.equals("5AN")) { str = "LL"; }
        else if(str.equals("5N9")) { str = "LL"; }
        else if(str.equals("5C3")) { str = "LNA"; }
        else if(str.equals("5C4")) { str = "LNA"; }
        else if(str.equals("5C5")) { str = "LNA"; }
        else if(str.equals("5NA")) { str = "LNB"; }
        else if(str.equals("5NC")) { str = "LNB"; }
        else if(str.equals("5A4")) { str = "LNC"; }
        else if(str.equals("5C2")) { str = "LNC"; }
        else if(str.equals("5K7")) { str = "LND"; }
        else if(str.equals("5K8")) { str = "LND"; }
        else if(str.equals("5C1")) { str = "LNE"; }
        else if(str.equals("5C9")) { str = "LNE"; }
        else if(str.equals("5A9")) { str = "LNH"; }
        else if(str.equals("5LA")) { str = "LNJ"; }
        else if(str.equals("5LC")) { str = "LNJ"; }
        else if(str.equals("5AT")) { str = "LNK"; }
        else if(str.equals("5K5")) { str = "LNL"; }
        else if(str.equals("5K6")) { str = "LNL"; }
        else if(str.equals("5H1")) { str = "LNM"; }
        else if(str.equals("5HX")) { str = "LNM"; }
        else if(str.equals("5HY")) { str = "LNM"; }
        else if(str.equals("5A5")) { str = "LNN"; }
        else if(str.equals("5M6")) { str = "LNN"; }
        else if(str.equals("5LG")) { str = "LNP"; }
        else if(str.equals("5M7")) { str = "LNP"; }
        else if(str.equals("5K9")) { str = "LNR"; }
        else if(str.equals("5LD")) { str = "LNS"; }
        else if(str.equals("5LE")) { str = "LNS"; }
        else if(str.equals("5LF")) { str = "LNS"; }
        else if(str.equals("5A7")) { str = "LNT"; }
        else if(str.equals("5A8")) { str = "LNW"; }
        else if(str.equals("TAK")) { str = "LNW"; }
        else if(str.equals("5NT")) { str = "MAN"; }
        else if(str.equals("5D9")) { str = "MID"; }
        else if(str.equals("5E1")) { str = "MID"; }
        else if(str.equals("5KM")) { str = "MID"; }
        else if(str.equals("5QR")) { str = "MID"; }
        else if(str.equals("5D7")) { str = "NEW"; }
        else if(str.equals("5D8")) { str = "NEW"; }
        else if(str.equals("5PQ")) { str = "NF"; }
        else if(str.equals("5PR")) { str = "NF"; }
        else if(str.equals("5EM")) { str = "NN"; }
        else if(str.equals("5ET")) { str = "NN"; }
        else if(str.equals("5N8")) { str = "NN"; }
        else if(str.equals("5PD")) { str = "NO"; }
        else if(str.equals("TAC")) { str = "NR"; }
        else if(str.equals("5QE")) { str = "OX"; }
        else if(str.equals("5JX")) { str = "ROC"; }
        else if(str.equals("5NQ")) { str = "ROC"; }
        else if(str.equals("5H8")) { str = "ROT"; }
        else if(str.equals("5M2")) { str = "SA"; }
        else if(str.equals("5MK")) { str = "SA"; }
        else if(str.equals("7A4")) { str = "SGA"; }
        else if(str.equals("7A5")) { str = "SGA"; }
        else if(str.equals("5N4")) { str = "SHE"; }
        else if(str.equals("5F5")) { str = "SLF"; }
        else if(str.equals("5NR")) { str = "SLF"; }
        else if(str.equals("5QL")) { str = "SM"; }
        else if(str.equals("5FE")) { str = "SO"; }
        else if(str.equals("5L1")) { str = "SO"; }
        else if(str.equals("5QC")) { str = "SO"; }
        else if(str.equals("5QT")) { str = "SO"; }
        else if(str.equals("5NJ")) { str = "SOP"; }
        else if(str.equals("5F7")) { str = "SPT"; }
        else if(str.equals("5PH")) { str = "ST"; }
        else if(str.equals("5PJ")) { str = "ST"; }
        else if(str.equals("5PK")) { str = "ST"; }
        else if(str.equals("5J4")) { str = "STL"; }
        else if(str.equals("5NM")) { str = "STL"; }
        else if(str.equals("5PT")) { str = "SU"; }
        else if(str.equals("5KL")) { str = "SUN"; }
        else if(str.equals("5P5")) { str = "SY"; }
        else if(str.equals("5LQ")) { str = "TE"; }
        else if(str.equals("5P7")) { str = "TE"; }
        else if(str.equals("5P8")) { str = "TE"; }
        else if(str.equals("5P6")) { str = "TW"; }
        else if(str.equals("5PM")) { str = "WA"; }
        else if(str.equals("5N3")) { str = "WAK"; }
        else if(str.equals("5M3")) { str = "WAL"; }
        else if(str.equals("5PF")) { str = "WBH"; }
        else if(str.equals("7A3")) { str = "WGA"; }
        else if(str.equals("5HG")) { str = "WIG"; }
        else if(str.equals("5HQ")) { str = "WIG"; }
        else if(str.equals("5K3")) { str = "WL"; }
        else if(str.equals("5QK")) { str = "WL"; }
        else if(str.equals("5QW")) { str = "WMF"; }
        else if(str.equals("TAM")) { str = "WMF"; }
        else if(str.equals("5MV")) { str = "WOM"; }
        else if(str.equals("5CN")) { str = "WR"; }
        else if(str.equals("5PL")) { str = "WR"; }
        else if(str.equals("5NV")) { str = "YN"; }
        else if(str.equals("5J6")) { str = "YW"; }
        else if(str.equals("5N2")) { str = "YW"; }
