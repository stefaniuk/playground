...
], function(dojo, code4ge, declare, ClientFilter, JsonRestStore, JsonRpc) {

var JsonRpcStore = declare('code4ge.data.JsonRpcStore', null, {
...
code4ge.set('jsonrpcstore.registry', JsonRpcStore.prototype.registry);
